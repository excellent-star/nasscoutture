...
<div class="content-body">
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Commande</a></li>
                                    ...
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        ...
                                        <tbody id="table_body">
                                            ...
                                            @foreach($order_items as $key => $item)
                                                 ...
                                                 @if(!($item==0))
                                                    ...
                                                    <tr class="articles_ordered">
                                                        <td>{{$key}}</td>
                                                        <td>
                                                            <input data-quantity-value="{{$item}}"  class="quantity_item form-control quantity_{{$key}}" value="{{$item}}" type="number"  min="0"/>
                                                        </td>
                                                        <td>
                                                        <input data-prix_unit-value="0" class="prixu_item form-control prixu_{{$key}}" type="number" value="0" min="0"/>
                                                        </td>
                                                        <td>
                                                            <span style="font-weight: bold;font-size:15px;" class="total_item total_{{$key}}">0</span> (frcfa)
                                                        </td>
                                            ...
                                            <tr>
                                                        ...
                                                        <td colspan="2">
                                                             <span>Total : <span id="total_commande" style="font-weight:bold;">   0   </span>   (frcfa)</span>
                                                        </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>   
                                                     <input type="number" id="avance_input" class="form-control" min="0"/>
                                                    </td>
           ...
           $("#store_order").click(function(){
                     ...
                     for(let i=0;i< articles_ordered.length;i++){
                            ...
                            var article = tr_children[0].innerText;
                                ...
                                _dataToSend.push({"article":article,"quantity":_quantity,"price":_prix_unit});
                            if(_quantity <=0)
                            {
                        ...
                        if(date_retrait=="")
                        {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.value) {
                                        ...
                                        $.ajax({
                                            url:'http://127.0.0.1:8000/store-order',
                                            method: 'POST',
                                            data: formData,
                                            dataType: 'JSON',
                                            contentType: false,
